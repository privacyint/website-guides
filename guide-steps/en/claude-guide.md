...
Once this is done, go through the settings of the app you had previously connected and remove Claude from the third party apps with access (for example for Google, follow [these instructions](https://support.google.com/accounts/answer/13533235?hl=en)).

![Claude connectors](../../images/Claude/claude_connectors.png?raw=true)
#### Prevent usage of your data to train the model
...
**On the mobile app:**  
Go to your profile by clicking the menu in the top left corner and taping on your profile in the bottom left corner. Navigate to **Privacy** and turn off the **You can help improve Claude** setting. Then click **Not now** to confirm.
...
![Delete chat in Claude](../../images/Claude/claude_delete_chat.png?raw=true)
